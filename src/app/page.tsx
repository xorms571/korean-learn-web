        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-800">Systematic Curriculum</h3>
              <p className="text-gray-600">Structured learning process from beginner to advanced levels</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-800">Active Community</h3>
              <p className="text-gray-600">Connect and share information with other learners</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-800">Practical Learning</h3>
              <p className="text-gray-600">Learn practical Korean expressions you can use in daily life</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Begin with free basic courses and improve your Korean skills
          </p>
          <Link 
            href="/signup" 
