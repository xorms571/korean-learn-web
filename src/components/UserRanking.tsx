          ...
          {topUsers.map((user, index) => (
            <li key={user.uid} className="flex items-center justify-between p-2 rounded-md hover:bg-gray-50">
              <div className="flex items-center">
                <span className="font-bold text-gray-700 mr-3">#{index + 1}</span>
                {user.photoURL ? (
              ...
              <div className="text-right flex flex-col w-[63.7px]">
                <span className="block text-sm text-blue-600 font-semibold text-nowrap">{user.completedLessons} courses</span>
